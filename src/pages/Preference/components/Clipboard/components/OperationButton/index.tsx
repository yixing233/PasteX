...
export const transferData: TransferData[] = [
  ...
  },
  {
    ...
    key: "open",
    title:
      "preference.clipboard.content_settings.label.operation_button_option.open",
  },
];
    ...
    <>
      ...
      >
        <Transfer
          ...
          titles={[
            t(
              "preference.clipboard.content_settings.label.operation_button_hidden",
            ),
            t(
              "preference.clipboard.content_settings.label.operation_button_shown",
            ),
          ]}
        >
          {renderTree}
