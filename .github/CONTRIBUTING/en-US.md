...
Thanks for your interests and contributions to `PasteX`! Before you submit your Pull Request, please take a moment to review the following guidelines to ensure a smooth process.
...
We use [GitHub Issues](https://github.com/yixing233/PasteX/issues) for bug reports and feature suggestions.
...
- [Rust](https://v2.tauri.app/start/prerequisites/): Install Rust according to the official instructions.
...
We're looking forward to your contributions to make PasteX much better!
