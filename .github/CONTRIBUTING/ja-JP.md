...
`PasteX` に関心と貢献を寄せていただきありがとうございます！プルリクエストを送信する前に、スムーズなプロセスを確保するために以下のガイドラインを確認してください。
...
バグ報告と機能提案のために[GitHub Issues](https://github.com/yixing233/PasteX/issues)を使用しています。
...
- [Rust](https://v2.tauri.app/start/prerequisites/): 公式の指示に従って Rust をインストールしてください。
